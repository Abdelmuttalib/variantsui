...
export function BackgroundBeamsDemo() {
  return (
    <div className="h-screen w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4 text-center flex flex-col gap-y-2">
        ...
        <span className="rounded-lg border border-neutral-800 focus:ring-2 focus:ring-teal-500 w-fit mx-auto relative z-10 mt-4 bg-neutral-950 text-neutral-700 px-4 py-2">
          Coming soon
        </span>
        {/* <input
          type="text"
